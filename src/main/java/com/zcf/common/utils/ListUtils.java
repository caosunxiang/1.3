...
public class ListUtils {
    ...
    public static <E> void sort(List<E> list, final boolean isAsc, final String sortname) {
        Collections.sort(list, new Comparator<E>() {
            ...
            public int compare(E a, E b) {
                int ret = 0;
                try {
                    ret = ListUtils.compare(sortname, isAsc, a, b);
     ...
     * @throws Exception
     */
    private static <E> int compare(final String sortname, final boolean isAsc, E a, E b) throws Exception {
        int ret;
        ...
        Double double2 = Double.valueOf(value2.toString());

        if (isAsc) {
            ret = double1.compareTo(double2);
        } else {
            ret = double2.compareTo(double1);
        }
        return ret;
    }
